...
class ADODB_Pager {
	...
	var $gridAttributes = 'width=100% border=0 bgcolor=white';
	...
	function RenderPageCount()
	{
		...
		return "<font size=3>$this->page ".$this->curr_page."/".$lastPage."</font>";
	}
	...
	function RenderLayout($header,$grid,$footer,$attributes='border=0 cellpadding="5" cellspacing="0" bgcolor=#EFEFEF style="width:100%;"')
	{
		echo "<table ".$attributes."><tr><td>",
				$header,
			"</td></tr><tr style='height:10px;background-color:#FFFFFF;'><td></td></tr><tr><td>",
				$grid,
			"</td></tr><tr style='height:10px;background-color:#FFFFFF;'><td></td></tr><tr><td>",
				$footer,
			"</td></tr></table>";
